    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                n2 = n2/100;
                double n3 = Integer.parseInt(request.getParameter("n3"));
                double vf = n1*(1+n2*n3);
                out.println("<h2>VP*(1+j*n)=VF</h2>");
                out.println("<h2>"+n1+"*(1+"+n2+"*"+n3+")=VF</h2>");
                out.println("<h2>"+n1+"*(1+"+n2+"*"+n3+")="+vf+"</h2>");
                out.println("<h2>Valor Futuro[VF]= "+vf+"</h2>");
            }catch(Exception ex){
